class Solution 
{
    public int climbStairs(int n) 
    {
        ...
        return climbStairsHelper(n,dp,0);
    } 

    public int climbStairsHelper(int n, Map<Integer,Integer> dp, int idx) 
    {
        ...
        if(!dp.containsKey(idx))
        {
            dp.put(
                idx, 
                climbStairsHelper(n,dp,idx+1)
                +
                climbStairsHelper(n,dp,idx+2)
            );
        }   
        return dp.get(idx);
    } 
